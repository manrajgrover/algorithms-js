...
describe('validTraingle', () => {
  it('should return false if the sum of two sides is less than or equal to the third', () => {
    assert.equal(false, validTraingle(1, 2, 3));
    assert.equal(false, validTraingle(3, 6, 9));
    assert.equal(false, validTraingle(5, 10, 16));
  });

  it('should return true if the sum of two sides is always greater than the third', () => {
