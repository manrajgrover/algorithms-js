...
describe('Quick Sort', () => {
  ...
  it('should sort the array', () => {
    const inst = new QuickSort([2, 1, 3, 4]);
  ...
  it('should sort the array in ascending order with few equal vals', () => {
    const inst = new QuickSort([2, 1, 3, 4, 2], (a, b) => a < b);
  ...
  it('should sort the array in decending order', () => {
    const inst = new QuickSort([2, 1, 3, 4], (a, b) => a > b);
    assert.equal(inst.size, 4);
